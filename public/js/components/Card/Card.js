...
var _Card_instances, _Card_cardData, _Card_getPokemonTypes, _Card_getFormattedZeros, _Card_getFormattedSizes, _Card_getDetailedInfo;
...
export default class Card extends Component {
    ...
    `;
        __classPrivateFieldGet(this, _Card_instances, "m", _Card_getDetailedInfo).call(this);
    }
}
...
}, _Card_getDetailedInfo = function _Card_getDetailedInfo() {
    this.domElement.addEventListener('click', () => {
        localStorage.setItem('selectedPokemon', JSON.stringify(__classPrivateFieldGet(this, _Card_cardData, "f").id));
